...
global do_appfigure_a3 = 1  // Comparison with Military Spending: Detail
global do_appfigure_a4 = 1  // Natural Disasters and Sport Events
global do_appfigure_a5 = 1  // GPR Political Slant
global do_appfigure_a6 = 1  // Hijackings, Murders...
global do_appfigure_a12 = 1  // GPR Individual Newspapers
global do_appfigure_a13 = 1  // Search Categories
global do_appfigure_a14 = 1  // Human Index
global do_appfigure_a15 = 1  // GPR Ex econ words
global do_appfigure_a16 = 1  // GPR and Other Proxies
...
graph combine rameyall ramey4, rows(2) name(FA3, replace) graphregion(fcolor(white))
...
graph combine zz1 zz3, name(FA4, replace) rows(3)
...
name(FA5, replace) graphregion(fcolor(white)) 

graph export results\figure_A5.eps, name(FA5) replace logo(off) mag(100) 
...
graph combine GPRIND1 GPRIND2 GPRIND3 GPRIND4 GPRIND5, name(FA12, replace) rows(3)
...
graph combine HH1 HH2 HH3 , name(FA6, replace) rows(3) graphregion(fcolor(white)) 
graph display, ysize(3) xsize(2.5) 
graph export results\figure_A6.eps,  name(FA6) replace logo(off) mag(100) 
...
graph combine BLOCK1 BLOCK2 BLOCK3 BLOCK4, rows(2) name(FA13, replace) graphregion(fcolor(white))
...
name(FA14, replace) graphregion(fcolor(white)) 
...
name(FA15, replace) graphregion(fcolor(white)) 





graph export results\figure_A15.eps, name(FA15) replace logo(off) mag(100) 
...
graph combine ICB EPUNATSEC ICRG, name(FA16, replace) rows(3) 

graph display, ysize(3) xsize(2.5) 

graph export results\figure_A16.eps,  name(FA16) replace logo(off) mag(100) 

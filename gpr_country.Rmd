...
#### Download our monthly data here: <u> [Excel format](/gpr_files/data_gpr_export.xls)</u>; <u>[Stata format](/gpr_files/data_gpr_export.dta)</u> <br><i> The monthly data are updated at the beginning of each month.* (Last update: December 1, 2024).<br>The monthly data include the country-specific GPR indexes.<br>Each series mnemonics is described in the last columns of the Excel file and in the Stata file. </i>
#### Daily data for the Recent GPR index are available here: <u> [Excel format](/gpr_files/data_gpr_daily_recent.xls)</u>; <u>[Stata format](/gpr_files/data_gpr_daily_recent.dta)</u> <br><i> The daily data are updated every Monday.* (Last update: December 23, 2024) </i>
